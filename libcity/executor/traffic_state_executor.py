...
class TrafficStateExecutor(AbstractExecutor):
    def __init__(self, config, model):
        ...
        # 计算参数数量
        count_parameters_per_module(self.model)
    ...
    def save_model_with_epoch(self, epoch):
        ...
        config['epoch'] = epoch
        model_path = self.cache_dir + '/' + 'DGSTA' + '_' + self.config['dataset'] + '_epoch%d.tar' % epoch
