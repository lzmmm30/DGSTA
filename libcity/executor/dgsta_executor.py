...
class DGSTAExecutor(TrafficStateExecutor):
    ...
    def _build_optimizer(self):
        ...
        elif self.learner.lower() == 'adamw':  # true
    ...
    def _build_lr_scheduler(self):
        if self.lr_decay:
            ...
            elif self.lr_scheduler_type.lower() == 'cosinelr':  # true
    ...
    def train(self, train_dataloader, eval_dataloader):
        ...
        for epoch_idx in range(self._epoch_num, self.epochs):
            ...
            if (epoch_idx % self.log_every) == 0:
                ...
                message = 'Epoch [{}/{}] train loss: {:.4f}, val loss: {:.4f}, time: {:.2f}s'. \
                    format(epoch_idx, self.epochs, train_loss, val_loss, epoch_time)
    ...
    def _valid_epoch(self, eval_dataloader, epoch_idx, batches_seen=None, loss_func=None):
        with torch.no_grad():
            ...
            eval_dataloader = tqdm(eval_dataloader, desc='Value')
    ...
    def evaluate(self, test_dataloader):
        ...
        with torch.no_grad():
            ...
            filename = \
                ...
                + 'DGSTA' + '_' + self.config['dataset'] + '_predictions.npz'
